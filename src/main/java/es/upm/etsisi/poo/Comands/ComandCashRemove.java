...
/**
 * Busca el ID dentro del arrayList de elementos y si lo encuentra elimina el cajero, junto con sus tickets asociados,
 * en cambio, si no lo encuentra dispara un mensaje de error de que el ID no es correcto.
 */
